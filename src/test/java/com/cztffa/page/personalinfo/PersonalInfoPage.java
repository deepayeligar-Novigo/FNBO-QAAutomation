...
//		j.executeScript("arguments[0].click();",applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().addressText, person.getStreetAddress1()));
       // Thread.sleep(5000);
        WebElement addressText = applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().streetAddress1,person.getStreetAddress1());
        Thread.sleep(7000);
        browserActions.scrollElementIntoView(getSeleniumdriver(),addressText);
        wait(addressText);
        Thread.sleep(7000);
...
//		Thread.sleep(1000);
        ...
        browserActions.scrollElementIntoView(getSeleniumdriver(), element(getPersonalInfoPageModel().City, index));
        ...
        if ((validation == null) || validation != null && !validation.isSkipStateDropdown()) {
            Thread.sleep(10000);
            browserActions.scrollElementIntoView(getSeleniumdriver(), element(getPersonalInfoPageModel().State, index));
        ...
        browserActions.enterText(getSeleniumdriver(),
                ...
                person.getZip());
        Thread.sleep(5000);
        log.info("After entering county");
        if ((validation == null) || validation != null && !validation.isSkipStateDropdown()) {
            browserActions.scrollElementIntoView(getSeleniumdriver(), element(getPersonalInfoPageModel().County, index));
            browserActions.clickApply(getSeleniumdriver().getWebDriver(), element(getPersonalInfoPageModel().County, index));
////			Thread.sleep(3000);

            wait(getPersonalInfoPageModel().countyoptapply);
            browserActions.clickApply(getSeleniumdriver().getWebDriver(), getPersonalInfoPageModel().countyoptapply);
            Thread.sleep(5000);
            log.info("After entering state drop down ");
//		//**
////		j.executeScript("window.scrollBy(0,300)");
...
//
		//if ((validation == null) || validation != null && !validation.isSkipEmploymentStatusDropdown()) {
			//browserActions.clickApply(getSeleniumdriver().getWebDriver(), applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().employer, index));
...
//		Thread.sleep(2000);
            ...
            if (getSeleniumdriver().getWebDriver().getPageSource().contains("Identification Documents")) {
               ...
               browserActions.scrollElementIntoView(getSeleniumdriver(), applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().preferredId, index));
                Thread.sleep(2000);
               wait(element(getPersonalInfoPageModel().preferredId, index));

                browserActions.clickApply(getSeleniumdriver().getWebDriver(), applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().preferredId, index));
                Thread.sleep(7000);
...
//			Thread.sleep(3000);
//			j.executeScript("window.scrollBy(0,300)");
                WebElement idNumber = applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().identificationNumber, index);
                ...
                browserActions.enterText(getSeleniumdriver(), applicantUtil.getWebElement(getSeleniumdriver(), getPersonalInfoPageModel().identificationNumber, index),
